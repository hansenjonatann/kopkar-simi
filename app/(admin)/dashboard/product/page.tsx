          ...
          <table className="table-auto w-full ">
            <thead>
              <tr>
                ...
                <th className="border-t border-r border-l border-gray-500">Barcode</th>
                <th className="border-t border-r border-l border-gray-500">Code</th>
                <th className="border-t border-r border-l border-gray-500">Name</th>
                <th className="border-t border-r border-l border-gray-500">Category</th>
                <th className="border-t border-r border-l border-gray-500">Cost</th>
                <th className="border-t border-r border-l border-gray-500">Price</th>
                <th className="border-t border-r border-l border-gray-500">Stock</th>
            ...
            <tbody>
              {products.map((pro: any, index: number) => (
                <tr key={index} className="mt-3">
                  ...
                  <td className="border border-gray-500 text-center my-3">{pro.code}</td>
                  <td className="border border-gray-500 text-center my-3">{pro.name}</td>
                  <td className="border border-gray-500 text-center my-3">{pro.category.name}</td>
                  <td className="border border-gray-500 text-center my-3">{pro.cost.toLocaleString('id')}</td>
                  <td className="border border-gray-500 text-center my-3">{pro.price.toLocaleString('id')}</td>
                  <td className="border border-gray-500 text-center my-3">{pro.stock}</td>
                  <td className="border border-gray-500 text-center my-3">
                    <button onClick={() => handleDelete(pro.id)} className="bg-red-500 text-white p-2 m-2 rounded-md">
                      Delete
                    </button>
                  </td>
                </tr>
